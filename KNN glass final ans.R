...
table(glass$Type)
barplot(table(glass$Type),col='blue',xlab="type of glass",ylab='Count')
str(glass)
...
mean(test_df$type==pred_1,na.rm=T) # 0.620687
...
mean(test_df$type==model_2) # Accuracy is 0.5789
...
mean(test_df$type==model_final) # Accuracy is 0.65625
